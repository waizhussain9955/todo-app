      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in duration-700">
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-[10px] font-black text-primary-400 uppercase tracking-[0.2em]">Authentication Required</span>
          </div>
          <h1 className="text-5xl font-black tracking-tighter mb-4 text-white">
            Identify<span className="text-transparent bg-clip-text bg-main-gradient">.</span>
          </h1>
          <p className="text-secondary-text font-medium text-sm opacity-80">
            Secure entry protocol for task management nodes.
          </p>
        </div>
        ...
        <p className="text-center mt-10 text-secondary-text text-sm font-medium">
          New operative?{' '}
          <Link href="/register" className="text-primary-400 hover:text-primary-300 font-black uppercase tracking-wider transition-all underline underline-offset-8 decoration-primary-500/30">
            Join the Network
          </Link>
        </p>
      </div>
